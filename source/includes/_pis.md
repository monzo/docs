...
| CHF                | -                            | `UK.OBIE.IBAN`             | IBAN                           | -                                       | `UK.OBIE.BICFI`          | BIC                          | Required               |                                                                              |
| EUR                | `UK.OBIE.SEPACreditTransfer` | `UK.OBIE.IBAN`             | IBAN                           | -                                       | -                        | -                            | -                      |                                                                              |
| EUR                | `UK.OBIE.SWIFT`              | `UK.OBIE.IBAN`             | IBAN                           | -                                       | `UK.OBIE.BICFI`          | BIC                          | -                      |                                                                              |
| HUF                | -                            | `UK.OBIE.BBAN`             | Account Number                 | -                                       | -                        | Account Number               | Required               |                                                                              |
| HUF                | -                            | `UK.OBIE.IBAN`             | IBAN                           | -                                       | `UK.OBIE.BICFI`          | BIC                          | Required               |                                                                              |
...
| NZD                | -                            | `UK.OBIE.BBAN`             | Account Number                 | -                                       | -                        | -                            | Required               |                                                                              |
