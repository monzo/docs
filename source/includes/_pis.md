...
| BDT                | -                            | `UK.OBIE.BBAN`             | Account Number                 | Branch Routing Number                   | `UK.OBIE.NCC.BD`         | Bank Code                    | -                      | -                                                                                 | `Risk.BeneficiaryAccountType` must not be a business account type           |
| BDT                | -                            | `UK.MONZO.BKash`           | bKash Mobile Number             | -                                       | -                        | -                            | -                      | -                                                                                 | `Risk.BeneficiaryAccountType` must not be a business account type           |
...
| GHS                | -                            | `UK.OBIE.BBAN`             | Account Number                 | -                                       | `UK.OBIE.NCC.GH`         | Bank Code                    | -                      | -                                                                                 |                                                                              |
| GHS                | -                            | `UK.MONZO.GhanaMobile`     | Mobile Number                  | -                                       | `UK.OBIE.NCC.GH`         | Mobile Network Operator Code | -                      | -                                                                                 | `Risk.BeneficiaryAccountType` must be `Personal`, `JointPersonal`, or `PersonalSavingsAccount`  |
...
| QAR                | -                            | `UK.OBIE.BBAN`             | Account Number                 | -                                       | `UK.OBIE.BICFI`          | BIC                          | Required               | -                                                                                 | `PostCode` is not required for QAR                                          |
| RON                | -                            | `UK.OBIE.IBAN`             | IBAN                           | -                                       | `UK.OBIE.BICFI`          | BIC                          | Required               | -                                                                                 |                                                                              |
| SAR                | -                            | `UK.OBIE.IBAN`             | IBAN                           | -                                       | `UK.OBIE.BICFI`          | BIC                          | Required               | -                                                                                 |                                                                              |
