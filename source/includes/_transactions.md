...
```shell
$ http "https://production-api.gmon.io/transactions/$transaction_id" \
...
```shell
$ http "https://production-api.gmon.io/transactions" \
    "Authorization: Bearer $access_token" \
...
```shell
$ http PATCH "https://production-api.gmon.io/transactions/$transaction_id" \
    "Authorization: Bearer $access_token" \
