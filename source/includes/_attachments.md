...
```shell
$ http --form POST "https://production-api.gmon.io/attachment/upload" \
...
```shell
$ http --form POST "https://production-api.gmon.io/attachment/register" \
    "Authorization: Bearer $access_token" \
...
```shell
$ http --form POST "https://production-api.gmon.io/attachment/deregister" \
    "Authorization: Bearer $access_token" \
    "id=attach_00009238aOAIvVqfb9LrZh"
```
